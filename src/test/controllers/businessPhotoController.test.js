...
describe('Business Photo Controller', function() {
  ...
  it('should update a business photo', async function() {
    const res = await request(app)
      .put('/business-photos/1')
      .send({ photoUrl: 'https://example.com/updated-photo.jpg' });
    expect(res.status).to.equal(200);
    expect(res.body).to.have.property('photoUrl', 'https://example.com/updated-photo.jpg');
  });

  it('should delete a business photo', async function() {
